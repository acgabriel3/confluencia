...
considerar que o termo t possui em sua composição o seguinte redex: pterm\_app (pterm\_labs Q) P, e apenas (verificar) 
...
t2 via n beta reduções. \begin{coqdoccode}
\coqdocemptyline
\end{coqdoccode}
